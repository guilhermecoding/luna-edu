...
import { IconLayoutGrid, IconEdit, IconChevronRight, IconUsersGroup, IconSun, IconSunset2, IconMoon } from "@tabler/icons-react";
    ...
    return (
        <div className="flex flex-col items-center justify-center p-12 text-center border-2 border-dashed border-surface-border rounded-4xl">
            ...
            <p className="text-muted-foreground mt-2 max-w-sm mb-6">
                Crie um grupo selecionando a Matriz e a Série. O sistema criará automaticamente as turmas para cada disciplina.
            </p>
            <Link
