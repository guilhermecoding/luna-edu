...
type Color = "indigo" | "green" | "rose" | "emerald" | "purple" | "amber" | "blue" | "sky";
interface InfoBoxStudentsProps {
    label: string;
    value: number | string;
    color?: Color;
    icon?: ReactNode;
...
export default function InfoBoxStudents({ label, value, color = "indigo", icon, labelLink = "Ver todos", href, className }: InfoBoxStudentsProps) {
