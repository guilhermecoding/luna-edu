...
import { IconCirclePlusFilled, IconLayoutGrid } from "@tabler/icons-react";
        ...
        <Page>
            <Section>
                <div className="flex flex-row items-center gap-1 mb-3">
                    ...
                    <p className="text-muted-foreground font-bold">Turmas Físicas</p>
                </div>
                <div className="flex flex-col lg:flex-row gap-y-6">
                    <div className="flex-1">
                        <TitlePage
                            title={periodData.name}
                            description="Gerencie as turmas físicas (agrupamento de alunos) deste período letivo."
                        />
                    </div>
                    <div className="flex flex-1 justify-end items-end">
                        <ButtonLink className="w-full sm:w-auto" href={`/admin/${program}/periodos/${period}/grupos/novo`}>
