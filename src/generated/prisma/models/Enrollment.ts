...
export type EnrollmentOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"createdAt" | "courseId" | "studentId", ExtArgs["result"]["enrollment"]>
...
export interface EnrollmentDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const enrollmentWithCreatedAtOnly = await prisma.enrollment.findMany({ select: { createdAt: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Enrollments and only return the `createdAt`
   * const enrollmentWithCreatedAtOnly = await prisma.enrollment.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Enrollments and only return the `createdAt`
   * const enrollmentWithCreatedAtOnly = await prisma.enrollment.updateManyAndReturn({
   *   select: { createdAt: true },
   *   where: {
   *     // ... provide filter here
   *   },
